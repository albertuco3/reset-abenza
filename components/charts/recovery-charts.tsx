  ...
  return (
    <section className="rounded-2xl bg-white p-4 ring-1 ring-zinc-200">
      <div className="mb-3">
        ...
        <p className="text-xs text-zinc-500">Sueño · energía</p>
      </div>
      {!hasAny ? (
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Mini title="Sueño (1-10)" dataKey="sleep" data={series} color="#3f6212" />
          <Mini title="Energía (1-10)" dataKey="energy" data={series} color="#365314" />
        </div>
      )}
    </section>
  );
...
function Mini({
  ...
  data: { date: string; sleep: number | null; energy: number | null }[];
  color: string;
}) {
  return (
    <div>
